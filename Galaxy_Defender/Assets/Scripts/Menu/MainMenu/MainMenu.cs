...
public enum MainMenuSpriteIndex
{
...
public class MainMenu : MonoBehaviour, IMenuStateHandler
{
    ...
    public void EnableMenu()
    {
        ...
        Button_Difficulty buttonDifficulty = sprites[(int)MainMenuSpriteIndex.SPRITE_INDEX_DIFFICULTY].gameObject.GetComponent<Button_Difficulty>() as Button_Difficulty;
        ...
        Button_Quit buttonQuit = sprites[(int)MainMenuSpriteIndex.SPRITE_INDEX_QUIT].gameObject.GetComponent<Button_Quit>() as Button_Quit;
        if (buttonQuit != null)
        {
        ...
        Button_Volume buttonVolume = sprites[(int)MainMenuSpriteIndex.SPRITE_INDEX_VOLUME].gameObject.GetComponent<Button_Volume>() as Button_Volume;
        ...
        Button_Achievements buttonAchievements = sprites[(int)MainMenuSpriteIndex.SPRITE_INDEX_ACHIEVEMENTS].gameObject.GetComponent<Button_Achievements>() as Button_Achievements;
    ...
    void InitializeMenu()
    {
        ...
        int spriteCount = (int)MainMenuSpriteIndex.SPRITE_INDEX_COUNT;
        for ( int index = 0; index < spriteCount ; ++index )
        {
            ...
            if( sprites[index] != null )
            {
                ...
                if( index == (int)MainMenuSpriteIndex.SPRITE_INDEX_TOP_BAR )
                {
        ...
        sprites[(int)MainMenuSpriteIndex.SPRITE_INDEX_QUIT].SetPosition(Screen.width - sprites[(int)MainMenuSpriteIndex.SPRITE_INDEX_QUIT].getScaledSize().x, 0);
        //-- position the volume button
        sprites[(int)MainMenuSpriteIndex.SPRITE_INDEX_VOLUME].SetPosition(Screen.width - sprites[(int)MainMenuSpriteIndex.SPRITE_INDEX_VOLUME].getScaledSize().x * 2.0f, 0);
        //-- position the achievements button
        sprites[(int)MainMenuSpriteIndex.SPRITE_INDEX_ACHIEVEMENTS].SetPosition(Screen.width - sprites[(int)MainMenuSpriteIndex.SPRITE_INDEX_ACHIEVEMENTS].getScaledSize().x * 3.0f, 0);
    }
    ...
    {
        menuController.Push( menuController.volumeMenu );
    }

    public void GoToAchievements()
    {
        menuController.Push( menuController.achievementMenu );
    }
}
